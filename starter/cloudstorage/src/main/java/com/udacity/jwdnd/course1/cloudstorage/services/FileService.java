...
public class FileService {
    ...
    public List<UserFile> getFilesByUser(String username) {return this.userFileMapper.getFileByUsername(username);}
    ...
    public File getFileByFileId(Integer fileId) {return this.fileMapper.getFileById(fileId);}
}
